...
Public Class rptPrintInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjDentrix.rptPrintInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintInventory = New rptPrintInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
