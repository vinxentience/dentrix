...
Public Class rptPrintPatient
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "prjDentrix.rptPrintPatient.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrintPatient
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrintPatient = New rptPrintPatient()
        rpt.Site = Me.Site
        Return rpt
    End Function
